...
class load_mind:
    """
    Wrapper class for loading MIND datasets
    """

    def load_behaviors(temp_dir):
    ...
    def load_entity_embedding(temp_dir):
    ...
    def load_relation_embedding(temp_dir):
